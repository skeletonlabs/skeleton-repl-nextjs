...
export default function Home() {
  ...
  return (
	...
	<div className="container mx-auto grid grid-cols-[auto_1fr_auto] items-center gap-10 p-4">
		...
		<p className="text-xs opacity-60">Test various feature provided by Skeleton.</p>
		<a href="https://skeleton.dev" target="_blank" className="btn preset-filled">Documentation</a>
	</div>
</header>
...
<main className="container mx-auto space-y-20 px-4 py-20">
	...
	<section className="space-y-4">
		...
		<div className={previewCardClasses}>
			<div className="grid grid-cols-3 gap-4">
				...
				{/* --- */}
				<span className="badge preset-filled-tertiary-500">Badge</span>
	...
	<section className="space-y-4">
		...
		<div className={previewCardClasses}>
			<div className="grid grid-cols-3 gap-4">
				...
				<button type="button" className="btn preset-tonal-primary">Button</button>
				<button type="button" className="btn preset-outlined-primary-500">Button</button>
				{/* --- */}
				<button type="button" className="btn preset-filled-secondary-500">Button</button>
				<button type="button" className="btn preset-tonal-secondary">Button</button>
				<button type="button" className="btn preset-outlined-secondary-500">Button</button>
				{/* --- */}
				<button type="button" className="btn preset-filled-tertiary-500">Button</button>
				<button type="button" className="btn preset-tonal-tertiary">Button</button>
				<button type="button" className="btn preset-outlined-tertiary-500">Button</button>
				{/* --- */}
				<button type="button" className="btn preset-filled-success-500">Button</button>
				<button type="button" className="btn preset-tonal-success">Button</button>
				<button type="button" className="btn preset-outlined-success-500">Button</button>
				{/* --- */}
				<button type="button" className="btn preset-filled-warning-500">Button</button>
				<button type="button" className="btn preset-tonal-warning">Button</button>
				<button type="button" className="btn preset-outlined-warning-500">Button</button>
				{/* --- */}
				<button type="button" className="btn preset-filled-error-500">Button</button>
				<button type="button" className="btn preset-tonal-error">Button</button>
				<button type="button" className="btn preset-outlined-error-500">Button</button>
				{/* --- */}
				<button type="button" className="btn preset-filled-surface-500">Button</button>
				<button type="button" className="btn preset-tonal-surface">Button</button>
				<button type="button" className="btn preset-outlined-surface-500">Button</button>
			</div>
		</div>
	</section>
			...
			<form className="w-full max-w-xl mx-auto space-y-4">
				<fieldset className="space-y-4">
					...
					<label className="label">
						...
						<textarea className="textarea rounded-container" rows={4} placeholder="Lorem ipsum dolor sit amet consectetur adipisicing elit."
						></textarea>
					</label>
					{/* Search */}
					<label className="label">
	...
	<section className="space-y-4">
		...
		<div className={previewCardClasses}>
			<div className="flex space-x-8">
				...
				<Switch name="compact" controlWidth="w-12" controlActive="preset-filled-tertiary-500" compact inactiveChild={<span>💀</span>} activeChild={<span>👨</span>}/>
			</div>
		</div>
	</section>
	...
	<section className="space-y-4">
		...
		<div className={previewCardClasses}>
			<div>Press <kbd className="kbd">⌘</kbd> + <kbd className="kbd">C</kbd> to copy.</div>
		</div>
	</section>
	...
	<section className="space-y-4">
		...
		<div className={previewCardClasses}>
			<ol className="flex items-center gap-4">
				<li><a className="opacity-60 hover:underline" href="#breadcrumbs">Blog</a></li>
				<li className="opacity-50" aria-hidden="true">&rsaquo;</li>
				<li><a className="opacity-60 hover:underline" href="#breadcrumbs">Category</a></li>
				<li className="opacity-50" aria-hidden="true">&rsaquo;</li>
				<li>Article</li>
			</ol>
		</div>
		...
		<div className={previewCardClasses}>
			<section className="grid grid-cols-2 gap-4 md:grid-cols-4">
				...
				<div className="grid gap-4">
					<Image width={220} height={320} className="bg-surface-500 rounded-container" src="https://picsum.photos/220/320?random=1" alt="Random" />
					<Image width={220} height={120} className="bg-surface-500 rounded-container" src="https://picsum.photos/220/120?random=2" alt="Random" />
					<Image width={220} height={280} className="bg-surface-500 rounded-container" src="https://picsum.photos/220/280?random=3" alt="Random" />
				</div>
				{/* Column */}
				<div className="grid gap-4">
					<Image width={220} height={300} className="bg-surface-500 rounded-container" src="https://picsum.photos/220/300?random=4" alt="Random" />
					<Image width={220} height={280} className="bg-surface-500 rounded-container" src="https://picsum.photos/220/280?random=5" alt="Random" />
					<Image width={220} height={140} className="bg-surface-500 rounded-container" src="https://picsum.photos/220/140?random=6" alt="Random" />
				</div>
				{/* Column */}
				<div className="grid gap-4">
					<Image width={220} height={280} className="bg-surface-500 rounded-container" src="https://picsum.photos/220/280?random=7" alt="Random" />
					<Image width={220} height={320} className="bg-surface-500 rounded-container" src="https://picsum.photos/220/320?random=8" alt="Random" />
					<Image width={220} height={140} className="bg-surface-500 rounded-container" src="https://picsum.photos/220/140?random=9" alt="Random" />
				</div>
				{/* Column */}
				<div className="grid gap-4">
					<Image width={220} height={320} className="bg-surface-500 rounded-container" src="https://picsum.photos/220/320?random=10" alt="Random" />
					<Image width={220} height={140} className="bg-surface-500 rounded-container" src="https://picsum.photos/220/140?random=11" alt="Random" />
					<Image width={220} height={140} className="bg-surface-500 rounded-container" src="https://picsum.photos/220/280?random=12" alt="Random" />
				</div>
			</section>
		</div>
	</section>
